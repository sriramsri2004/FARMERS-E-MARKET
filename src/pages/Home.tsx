        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-50 md:h-96 lg:h-full rounded-3xl overflow-hidden shadow-2xl animate-scale-in transform hover:scale-105 transition-transform duration-500">
              <img src="/lovable-uploads/banner.jpg" alt="Fresh vegetables collage" className="w-full h-auto object-cover rounded-3xl bg-gradient-to-br from-white to-farmer-50" />
            </div>
          </div>
        </div>
        {/* Background pattern */}
